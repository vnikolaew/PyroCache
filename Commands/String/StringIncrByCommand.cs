...
public static class StringIncrBy
{
    /// <summary>
    ...
    public sealed class Command : BasePyroCommand
    {
            ...
            StringPackageInfo package)
        {
            ...
            var incrementBy = package.Parameters[1].Trim();
            ...
            if (int.TryParse(cacheEntry.Value, NumberStyles.Integer, new NumberFormatInfo(), out var value)
                && int.TryParse(incrementBy, NumberStyles.Integer, new NumberFormatInfo(), out var incrementByValue))
            {
    ...
    public sealed class Validator : ICommandValidator<Command>
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var incrementBy = parameters[1].Trim();
            if (!uint.TryParse(incrementBy, out _))
            {
